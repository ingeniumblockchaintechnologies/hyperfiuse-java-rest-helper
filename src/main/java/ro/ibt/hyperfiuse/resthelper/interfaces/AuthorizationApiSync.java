...
public interface AuthorizationApiSync {
	 ...
	 *                               not go as expected
	 */
	public RecordObjectList getEventList(String token, String ownerId, Boolean forceReload) throws RestResponseException;
	 ...
	 *                               not go as expected
	 */
	public String addGroupEntityPermisions(String token, String entityName, Object record) throws RestResponseException;
